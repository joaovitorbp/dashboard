...
# --- CÁLCULOS MACRO (LINHA 1) ---

# 1. Valor Vendido (Carteira Total) - INCLUI 'Não iniciado'
...
with row2_c1:
    ...
    <div class="kpi-card">
        ...
        <div class="kpi-val {cor_m_apr}">{mg_apresentada:.1f}%</div>
        <div class="kpi-sub">
...
with row2_c2:
    ...
    <div class="kpi-card">
        ...
        <div class="kpi-val {cor_m_fin}">{mg_finalizada:.1f}%</div>
        <div class="kpi-sub">
